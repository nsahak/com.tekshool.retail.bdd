...
public class LoginPageObj extends Base {
	...
	public LoginPageObj () {
		...
		// We will use initElements method of PageFactory class to initialize the WebElements of UI
		PageFactory.initElements(driver, this);
	}
	
	// PageFactory class provides @FindBy annotation to find UI elements.
	// driver.findElement (by.xpath("//tag[@attribute='value']))
	// the above code is same as below but, below code is used to implement PageFactory in POM Design Pattern
